...
To compile:
    g++ -o get_pen_pressure get_pen_pressure.cpp -lX11 -lXi

To run the sample
	./get_pen_pressure

Adapted from: https://github.com/Wacom-Developer/wacom-device-kit-linux/blob/master/X%20Events/SampleCode/pen-tip-values.c

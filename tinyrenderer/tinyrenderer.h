...
// color in the pixel
void triangle_filled_barycentric_coordinates(std::vector<Point> t, TGAImage& image, float light_intensity, std::vector<std::vector<float>>& zbuffer, TGAImage& texture_image, std::vector<Vec3> uv_coordinates);

void triangle_filled(std::vector<Point> t, std::vector<Vec3> t_world, TGAImage& image, float light_intensity, std::vector<std::vector<float>>& zbuffer, TGAImage& texture_image, std::vector<Vec3> uv_coordinates);
